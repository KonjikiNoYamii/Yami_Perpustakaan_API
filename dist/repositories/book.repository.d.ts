import type { Book, Prisma, PrismaClient } from "@prisma/client.js";
export declare class BookRepository {
  ...
  >;
  getBookByCategoryIdAndPublicationYear: () => Promise<
    (Prisma.PickEnumerable<
      Prisma.BookGroupByOutputType,
      ("tahunTerbit" | "categoryId")[]
    > & {
      _count: {
        id: number;
      };
